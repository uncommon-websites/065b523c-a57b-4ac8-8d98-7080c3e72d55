...
<script lang="ts">
	...
	name: "Zilin Dong",
	role: "Founder & CEO",
	image: "/generated/image-a-portrait-of-a-visionary-asian-founder-.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We didn’t start with connections—we started with chaos. We’re obsessed with making real-time operations as intelligent as the boardroom."`}
			/>
